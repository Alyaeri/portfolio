...
export class TactivSignageComponent implements OnInit {
  ...
  images = [
    {
      src: 'images/portfolio/tactiv-signage/signage/signage-1.jpg',
      text: 'Boardroom - Glass wall mounted base + laser cut logo'
    },
    {
      src: 'images/portfolio/tactiv-signage/signage/signage-2.jpg',
      text: 'ACM Aluminium'
    },
    {
      src: 'images/portfolio/tactiv-signage/signage/signage-3.jpg',
      text: 'Light box'
    },
    {
      src: 'images/portfolio/tactiv-signage/signage/signage-4.jpg',
      text: '3D Laser cut acrylic logo'
    },
    {
      src: 'images/portfolio/tactiv-signage/signage/signage-5.jpg',
      text: 'PVC panel walls, counter, and fascia'
    },
    {
      src: 'images/portfolio/tactiv-signage/signage/signage-6.jpg',
      text: 'Adhesive Decal Sticker'
    },
    {
      src: 'images/portfolio/tactiv-signage/signage/signage-7.jpg',
